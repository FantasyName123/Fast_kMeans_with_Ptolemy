...
"""
Important: These are old implementations of the kMeans algorithms. There are way faster versions in the file
'kMeansVariants', which should definitely be preferred. This file should much rather be treated as an archive.
"""


def lloyd_algorithm_old(data, k, initial_centroids):
    # initialise
...
def lloyd_algorithm_2_old(data, k, initial_centroids):
    """
...
def hamerly_algorithm_old(data, k, initial_centroids):
    # initialise
    centroids = initial_centroids
    assignment = dict.fromkeys(data, -1)
...
def hamerly_both_ptolemy_upper_bound_algorithm_old(data, k, initial_centroids):
    """
...
def hamerly_lower_ptolemy_upper_bound_algorithm_old(data, k, initial_centroids):
    """
...
def elkan_algorithm_old(data, k, initial_centroids):
    # Initialisation
    centroids = initial_centroids
    assignment = dict()
...
def elkan_lower_ptolemy_upper_bound_algorithm_single_old(data, k, initial_centroids):
    """
...
def elkan_lower_ptolemy_upper_bound_algorithm_multi_old(data, k, initial_centroids):
    """
...
def elkan_style_ptolemy_both_bounds_algorithm_single_old(data, k, initial_centroids):
    """
...
def elkan_style_triangle_ptolemy_combined_algorithm_single_old(data, k, initial_centroids):
    """
...
def elkan_algorithm_without_counting_old(data, k, initial_centroids):
    # Initialisation
    centroids = initial_centroids
    assignment = dict()
    # the points are the keys and each value is a list of lower bounds with length k
    ...
    while not_converged:
        iteration_count += 1
        # in the first iteration, only the centroids get updated, and we do not check the convergence condition
        if iteration_count > 2:
            not_converged = False
        # 1
        for label, centroid in enumerate(centroids):
